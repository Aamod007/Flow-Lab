...
export const EditorCanvasDefaultCardTypes = {
  ...
  Agent: {
    description: 'Add a custom AI agent to your workflow.',
    type: 'Action',
  },
  'Research Agent': {
    description: 'Searches the web, gathers information, and compiles research.',
    type: 'Action',
  },
  'Coder Agent': {
...
export const CONNECTIONS: Connection[] = [
  // Communication - With API keys configured
  {
    title: 'Slack',
